...
function PermissionMenuAssign() {
  ...
  const handleSelectAll = (checked) => {
    if (checked) {
      setSelectedRows(permissionMenuData.map((item) => item.id));
    } else {
      setSelectedRows([]);
    }
  };
    ...
    <div className="permission-menu-assign">
      ...
      <div className="permission-filter-section">
        <div className="permission-field">
          ...
          >
            <option>BWI TEAM</option>
            <option>MIS TEAM</option>
            <option>P-Team UK</option>
            <option>P-Team US</option>
            <option>PW-TEAM</option>
            <option>QC TEAM</option>
          </select>
        </div>
        ...
        <div className="permission-field">
          ...
          >
            ...
            <option>Ssathish Padmanaban</option>
          </select>
        </div>
      ...
      <div className="permission-table-wrapper">
        <table className="permission-table">
          <thead>
            <tr>
              <th className="permission-sl-column">SL</th>
              <th>Main menu</th>
              <th>Sub menu</th>
          ...
          <tbody>
            {permissionMenuData.map((item) => (
              <tr key={item.id}>
                <td className="permission-sl-column">{item.id}</td>
                <td>{item.mainMenu}</td>
                <td>{item.subMenu}</td>
                <td className="permission-check-column">
                  <input
                    ...
                    aria-label={`Select ${item.subMenu}`}
                  />
                </td>
              </tr>
            ))}
...
function ModuleCard({ name, index, functionalityId, selected, onClick }) {
  ...
  return (
    <button
      className={`module-card ${selected ? "active" : ""}`}
      type="button"
      onClick={onClick}
